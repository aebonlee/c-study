...
int main() {
    ...
    return 0;
}`,expectedOutput:"Log entries written!\\n\\n=== Log Contents ===",lessonId:"c-lesson-09-practice"})]}),e.jsxs("div",{className:"c-lesson-nav-bottom",children:[e.jsxs(i,{to:"/c-learning/08",className:"c-lesson-nav-btn prev",children:[e.jsx("i",{className:"fa-solid fa-arrow-left"}),n==="en"?"Prev: Structs & Unions":"이전: 구조체와 공용체"]}),e.jsxs(i,{to:"/c-learning/10",className:"c-lesson-nav-btn next",children:[n==="en"?"Next: Data Structures":"다음: 자료구조 기초",e.jsx("i",{className:"fa-solid fa-arrow-right"})]})]})]})}export{a as default};
