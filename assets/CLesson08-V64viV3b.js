import{u as a,j as e,L as s}from"./index-Hg4q3ZOg.js";import{C as t}from"./CodeEditor-DKv8ZvQA.js";function o(){const{lang:n}=a();return e.jsxs("div",{className:"c-lesson-page",children:[e.jsxs("div",{className:"c-lesson-nav-top",children:[e.jsxs(s,{to:"/c-learning",children:[e.jsx("i",{className:"fa-solid fa-arrow-left"})," ",n==="en"?"Back to Curriculum":"커리큘럼으로 돌아가기"]}),e.jsx("span",{className:"c-lesson-week",children:"Week 08"})]}),e.jsxs("h1",{className:"c-lesson-title",children:[e.jsx("i",{className:"fa-solid fa-layer-group"}),n==="en"?"Week 8: Structs & Unions":"8주차: 구조체와 공용체"]}),e.jsxs("section",{className:"c-lesson-section",children:[e.jsx("h2",{children:n==="en"?"Structure Definition & Usage":"구조체 정의와 사용"}),e.jsx("p",{children:n==="en"?"A struct groups different data types into a single unit. It allows you to create custom data types:":"구조체는 서로 다른 자료형을 하나의 단위로 묶어줍니다. 사용자 정의 자료형을 만들 수 있습니다:"}),e.jsx(t,{initialCode:`#include <stdio.h>
#include <string.h>
