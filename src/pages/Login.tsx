      ...
      <div className="login-container">
        ...
        <div className="login-branding">
          <div className="login-branding-content">
            ...
            <p>{lang === 'en' ? 'Join C Programming Tutorial and start your journey to becoming a C programming expert.' : 'C Programming Tutorial에 가입하고 C 프로그래밍 전문가가 되는 여정을 시작하세요.'}</p>
        ...
        <div className="login-form-section">
          <div className="login-form-content">
            ...
            <div className="login-guest-info">
              ...
              <p>
                {lang === 'en'
                  ? 'You can use this platform without logging in. Logging in enables progress sync across devices and community features.'
                  : '로그인 없이도 이용할 수 있습니다. 로그인하면 기기 간 진행 상황 동기화와 커뮤니티 기능을 이용할 수 있습니다.'}
              </p>
            </div>
