...
const faqData = [
  {
    questionKo: 'C Programming Tutorial은 무엇인가요?',
    questionEn: 'What is C Programming Tutorial?',
    answerKo: 'C Programming Tutorial은 C언어를 체계적으로 학습할 수 있는 온라인 학습 플랫폼입니다. 초보자부터 고급 사용자까지 단계별로 학습할 수 있으며, 코드 에디터, 퀴즈, 배지 시스템 등 다양한 기능을 제공합니다.',
    answerEn: 'C Programming Tutorial is an online learning platform for systematically learning the C language. It supports learners from beginner to advanced levels with features like a code editor, quizzes, and a badge system.',
  },
  {
