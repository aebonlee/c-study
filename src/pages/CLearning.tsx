...
const steps = [
  {
    id: '01',
    titleKo: '1단계: C언어 소개와 개발 환경',
    titleEn: 'Step 1: Introduction to C & Dev Environment',
  ...
  {
    id: '02',
    titleKo: '2단계: 변수, 자료형, 연산자',
    titleEn: 'Step 2: Variables, Data Types & Operators',
  ...
  },
  {
    id: '04',
    titleKo: '4단계: 함수와 스코프',
    titleEn: 'Step 4: Functions & Scope',
  ...
  {
    id: '07',
    titleKo: '7단계: 포인터 심화와 동적 메모리',
    titleEn: 'Step 7: Advanced Pointers & Dynamic Memory',
  ...
  {
    id: '08',
    titleKo: '8단계: 구조체와 공용체',
    titleEn: 'Step 8: Structs & Unions',
  ...
  {
    id: '10',
    titleKo: '10단계: 자료구조 기초',
    titleEn: 'Step 10: Basic Data Structures',
  ...
  {
    id: '11',
    titleKo: '11단계: 종합 프로젝트',
    titleEn: 'Step 11: Final Project',
    ...
    <div className="c-learning-page">
            ...
            >
              ...
              <div className="curriculum-card-content">
                <div className="curriculum-card-header">
                  <div className="curriculum-icon" style={{ background: `${step.color}15`, color: step.color }}>
                    <i className={step.icon} />
                  </div>
                  <h3>{lang === 'en' ? step.titleEn : step.titleKo}</h3>
                </div>
                <p className="curriculum-desc">{lang === 'en' ? step.descEn : step.descKo}</p>
                <div className="curriculum-topics">
                  {step.topics.map((topic, i) => (
                    <span key={i} className="curriculum-topic-tag" style={{ background: `${step.color}15`, color: step.color }}>
                      {topic}
                    </span>
                  ))}
                </div>
                <div className="curriculum-card-footer">
                  <span className="curriculum-link" style={{ color: step.color }}>
      ...
      <section className="c-learning-cta">
        <div className="c-learning-cta-content">
          ...
          <p>{lang === 'en' ? 'Start from Step 1 and build your skills step by step.' : '1단계부터 시작하여 단계별로 실력을 쌓아보세요.'}</p>
          <Link to="/c-learning/01" className="cta-start-btn">
            <i className="fa-solid fa-play" />
            {lang === 'en' ? 'Start Step 1' : '1단계 시작하기'}
          </Link>
        </div>
      </section>
    </div>
